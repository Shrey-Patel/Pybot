...
class DefaultTest(unittest.TestCase):
    ...
    def test_call_default_for_wrong_dict_cmd(self):
        with patch.object(self.pybot, 'default') as default_mock:
            self.pybot._generate_output_if_dict(
    ...
    def test_call_default_for_words_before_1_word_dict_cmd(self):
        ...
        with patch.object(self.pybot, '_generate_output_if_dict') as generate_output_mock:
            self.pybot.precmd("please, could you enable")
        ...
        with patch.object(self.pybot, 'default') as default_mock:
            self.pybot._generate_output_if_dict(*args)
            self.assertTrue(default_mock.called)
